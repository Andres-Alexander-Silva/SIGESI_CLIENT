...
const proyectosPorSemilleros = [
  { semillero: 'SILUX',     cantidad: 12 },
  { semillero: 'Aplicaciones Móviles', cantidad: 8 },
  { semillero: 'SIWEB',     cantidad: 15 },
  { semillero: 'SIREDSE',   cantidad: 10 },
  { semillero: 'Videojuegos', cantidad: 6 },
  { semillero: 'Minería de Datos', cantidad: 9 },
  { semillero: 'SIA',       cantidad: 14 },
];
...
export default function DashboardDefault({ user }: { user: any }) {
  ...
  const tooltipStyle   = {
    ...
    color: isDark ? theme.palette.grey[50] : theme.palette.text.primary,
  };
          ...
          <Card sx={{ borderRadius: 3, height: '100%' }}>
            ...
            <CardContent sx={{ height: 320 }}>
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={proyectosPorSemilleros} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
                  <CartesianGrid strokeDasharray="3 3" stroke={chartGridColor} />
                  <XAxis dataKey="semillero" tick={{ fontSize: 11, fill: chartTickColor }} tickLine={false} axisLine={{ stroke: chartGridColor }} />
